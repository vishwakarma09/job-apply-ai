...
(function() {
  ...
  window.open = function(url, name, specs) {
    ...
    if (url && (url.includes("smartapply.indeed.com") || url.includes("apply.indeed.com") || url.includes("linkedin.com/checkout") || url.includes("linkedin.com/jobs") || url.includes("indeed.com/viewjob"))) {
